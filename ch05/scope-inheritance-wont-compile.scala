// scope-inheritance-wont-compile.scala
// WON'T COMPILE
...
package scopeA {
  ...
  class Class2 extends Class1 {
    ...
    val field2 = scopeB_protectedField
    val filed3 = class1_privateField    // ERROR
    val filed4 = class1_protectedField
...
package scopeB {
  class Class2B extends scopeA.Class1 {
    ...
    val filed2 = scopeA_protectedField
    val field3 = class1_privateField   // ERROR
    val filed4 = class1_protectedFiled
    val filed5 = this_privateField     // ERROR
    val filed6 = this_protectedField
  }
}
